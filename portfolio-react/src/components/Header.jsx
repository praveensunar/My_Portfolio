            ...
            <nav className="hidden md:flex items-center gap-8">
                {['Home', 'About', 'Skills', 'Portfolio', 'Contact'].map((item) => (
                    <Link
                        ...
                        offset={-70}
                        duration={500}
                        className="text-text font-medium text-lg transition-colors hover:text-accent hover:shadow-[0_0_10px_rgba(56,189,248,0.5)] cursor-pointer"
                ...
                <button
                    onClick={toggleTheme}
                    className="p-2 rounded-full border border-text text-text hover:bg-text hover:text-primary transition-all duration-300"
